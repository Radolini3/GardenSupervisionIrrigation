...
HAL_GPIO_WritePin(WATER_PIN_GPIO_Port, WATER_PIN_Pin, GPIO_PIN_SET); // odwrócona logika włączania przekaźnika zatem trza podać stan wysoki zeby wyłączyć
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
  /*Zwiększenie responsywności panelu sterowania*/
	 if (valueChanged == 1){
		 delay_us(500000);
